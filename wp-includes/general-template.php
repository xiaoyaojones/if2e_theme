...
function get_calendar($initial = true, $echo = true) {
    ...
    $calendar_output = '<h3 class="widget-title widget_calendar-hd">'. sprintf($calendar_caption, $wp_locale->get_month($thismonth), date('Y', $unixmonth)) .'</h3><div class="widget_calendar-bd"><table id="wp-calendar">
	<thead>
	<tr>';
